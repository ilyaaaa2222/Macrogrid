program macrogrid_solver
    ...
    call measure_time_with_gmres(one_sor, macrogrid, num_subgrids, subgrid_size, omega, max_iter, epsilon)
    ...
    !         call initialize_macrogrid(macrogrid, subgrid_size, num_subgrids)

    !         print *, "Running test with subgrid size: ", subgrid_size, " and number of subgrids: ", num_subgrids
    !         call measure_time(one_sor, macrogrid, subgrid_size, num_subgrids, omega, max_iter, epsilon)

    !         call compute_error(macrogrid, subgrid_size, num_subgrids)
    !         print *,""
    !     end do
    !     one_sor = .not.one_sor
    ! end do
    ...
    !         call initialize_hard_macrogrid(macrogrid, subgrid_size, num_subgrids)

    !         print *, "Running test with subgrid size: ", subgrid_size, " and number of subgrids: ", num_subgrids
    !         call measure_time(one_sor, macrogrid, subgrid_size, num_subgrids, omega, max_iter, epsilon)

    !         call compute_hard_error(macrogrid, subgrid_size, num_subgrids)
    !         print *,""
    !     end do
    !     one_sor = .not.one_sor
    ! end do
...
subroutine solve_macrogrid(one_sor, macrogrid, num_subgrids, subgrid_size, omega, max_iter, epsilon, iterations)
    ...
    do iter = 1, max_iter
        ...
        call update_boundaries(macrogrid, subgrid_size, num_subgrids, norm_boundaries)
